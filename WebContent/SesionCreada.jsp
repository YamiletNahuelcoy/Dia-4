...
<body>
		...
		<div class="content-menu">
			...
			<nav class="menu">
				<ul>
					...
					<li><a href="listarcapacitaciones.html">Listar
							Capacitaciones</a></li>
					<li><a href="administrarasistentes.html">Asistentes
							Capacitaciones</a></li>
	...
	<h2>La sesión ha sido creada exitosamente</h2>

	<a href="<%=request.getContextPath()%>/Contacto"> <p> Enviar a Página Contacto</p></a>
</body>
</html>